...
impl Flow {
    ...
    pub fn new(protocol: crate::Protocol) -> Option<Self> {
        match protocol {
            #[cfg(feature = "iso2")]
            crate::Protocol::Iso2 => Some(Self::Iso2(iso2::Sequencer::new())),
            #[cfg(feature = "iso20-common")]
    ...
    /// How long the session may stay in the phase it is in.
    ///
    ...
    #[must_use]
    pub const fn loop_timeout(&self) -> Option<Millis> {
        match self {
            #[cfg(feature = "iso2")]
            Self::Iso2(s) => s.loop_timeout(),
            #[cfg(feature = "iso20-common")]
            Self::Iso20(s) => s.loop_timeout(),
        }
    }
